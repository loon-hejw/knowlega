...
import { getLocale, installDomTranslator, setLocale, subscribeLocale, type Locale } from "./i18n.ts";
...
installDomTranslator(appEl as HTMLElement);
subscribeLocale(() => {
  renderSidebarTop();
  updateSidebarToggleLabels();
  for (const select of (appEl as HTMLElement).querySelectorAll<HTMLSelectElement>(".locale-select")) {
        ...
        <aside class="sidebar" aria-label="Navigation" @keydown=${onSidebarKeydown}>
          ...
          <div class="sidebar-footer">
            ...
            <label class="locale-picker">
              ...
              ${fieldSelect({
                className: "locale-field",
                selectClassName: "locale-select",
                compact: true,
                ariaLabel: "Language",
                title: "Language",
                value: getLocale(),
